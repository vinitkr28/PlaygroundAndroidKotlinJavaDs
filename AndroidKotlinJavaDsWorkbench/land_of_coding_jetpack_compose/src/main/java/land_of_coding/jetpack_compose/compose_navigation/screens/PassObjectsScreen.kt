...
@Composable
fun PassObjectsScreen(
    navigateToEnterPersonDataScreen: (Person) -> Unit,
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(onClick = {
                navigateToEnterPersonDataScreen.invoke(Person(77, personName, personAge, personCity))
            }) {
                Text(text = "Entered Person Data Screen")
            }
